# 🎸 Album Preview Invite - Interactive Mirror Breaking Experience

An immersive web experience where fans break a mirror by tapping it to reveal an exclusive invitation to your private album preview show.
...
- **Album Art Reveal**: Your album artwork appears behind the broken mirror
- **Show Invitation**: Clear call-to-action with ticket link

## 🚀 Quick Setup

### 1. Add Your Album Artwork

Place your album cover image at:
```
...
Edit `mirror-break.js` (lines 35-40):
...
Edit `mirror-break.js` (lines 28-34) to add your own hidden messages:
...
```bash
cd album-preview-invite
git init
git add .
git commit -m "Album preview invitation"
git branch -M main
...
2. **Enable GitHub Pages:**
   ...
   - Your URL: `https://YOUR-USERNAME.github.io/album-preview-invite/`
...
2. Drag the `album-preview-invite` folder onto the page
...
8. Album art revealed with show invitation
9. "GET YOUR TICKETS" button links to ticket page
...
└── assets/
    ├── album-art.jpg       # YOUR ALBUM ARTWORK (REQUIRED)
    └── easter-eggs/        # Optional easter egg images
```

## 🎵 Tips for Best Results

1. **Test on multiple devices** before launch
2. **Use high-quality album artwork** (1000x1000px+)
...
**Ready to launch?** Add your album artwork, configure your show details, and deploy! 🚀
